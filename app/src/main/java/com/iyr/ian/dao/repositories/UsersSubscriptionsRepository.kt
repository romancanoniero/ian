...
interface UsersSubscriptionsInterface {

    fun getUserSubscriptionsAsFlow(userKey: String): Flow<Resource<List<Subscription>?>>
    suspend fun getUserSubscriptionTypeAsFlow(userKey: String): Flow<Resource<SubscriptionTypes?>>


}

abstract class UsersSubscriptionsRespository : UsersSubscriptionsInterface {

    private val firebaseAuth = FirebaseAuth.getInstance()

    protected var tableName = "users_subscriptions"
