...
*/
class AddContactsFromPhoneFragment : Fragment() {
    ...
    private val args: AddContactsFromPhoneFragmentArgs by navArgs()
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding =
            DataBindingUtil.setContentView(
                requireActivity(),
                R.layout.activity_add_contacts_from_phone
            )
        /*
        ...
        contactAdapter = PhoneContactsAdapter(requireContext())
        getIntentData()
        setupUI()
    }
    ...
    private fun getIntentData() {
        ...
        bundle?.let {
            currentObject = Gson().fromJson(
                bundle?.getString("data_object"), User::class.java
            )
    ...
    private fun setupUI() {
        ...
        binding.skipButton.setOnClickListener {
            ...
            intent = if (!requireActivity().areLocationPermissionsGranted()) {
                Intent(requireContext(), LocationRequiredActivity::class.java)
            } else {
                Intent(requireContext(), SignUpCompletedActivity::class.java)
            }
    ...
    private fun retrieveContacts() {
        ...
        if (requireActivity().permissionsReadContacts()) {
...
//                            binding.percentIndicator.text = "$percent%"
                ...
                requireActivity().getContactList2(listener)
            }
    ...
    private fun loginGoogle() {
        lifecycleScope.launch(Dispatchers.IO) {
            ...
            val googleSignInClient1 = GoogleSignIn.getClient(requireActivity(), gso)
            ...
            RC_SIGN_IN_GOOGLE -> {
                ...
                try {
                    ...
                    when (e.statusCode) {
                        ...
                        12500 -> {
                            requireActivity().showErrorDialog(getString(R.string.error_google_sign_in_failed))
                        }

                        else -> {
                            requireActivity().showErrorDialog(e.localizedMessage)
                        }
                    }
...
// Crea una instancia de GoogleAccountCredential
        ...
        val credential = GoogleAccountCredential.usingOAuth2(
            requireContext(), listOf(PeopleServiceScopes.CONTACTS_READONLY)
        )
