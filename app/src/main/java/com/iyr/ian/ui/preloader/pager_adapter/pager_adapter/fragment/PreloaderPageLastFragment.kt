...
import com.iyr.ian.databinding.ItemPreloaderPageLastAdapterBinding
 ...
 */
class PreloaderPageLastFragment(context: Context) : Fragment() {

    var eventData: Event = Event()

    private lateinit var binding: ItemPreloaderPageLastAdapterBinding

    // TODO: Rename and change types of parameters
    private var param1: String? = null
    private var param2: String? = null

    fun PreloaderPageLastFragment() {
    ...
    override fun onCreateView(
        ...
        binding = ItemPreloaderPageLastAdapterBinding.inflate(layoutInflater)
        setupUI()
        updateUI()
