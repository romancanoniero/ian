...
import com.iyr.ian.databinding.FragmentContactGroupDeletionConfirmationPopupBinding
...
class ContactsGroupsDeletionConfirmationDialog() :
    AppCompatDialogFragment() {

    private val arguments: ContactsGroupsDeletionConfirmationDialogArgs by navArgs()
    ...
    protected lateinit var binding: FragmentContactGroupDeletionConfirmationPopupBinding
    override fun onCreateView(
        ...
        binding = FragmentContactGroupDeletionConfirmationPopupBinding.inflate(
        ...
        binding.groupName.setText(arguments.contactGroup.list_name)
        ...
        binding.yesButton.setOnClickListener { view ->
            ...
            viewModel.deleteGroup(arguments.contactGroup.list_key)
...
//                    dismiss()
        ...
        viewModel.deleteContactGroupAction.observe(this) { resource ->
            when (resource) {
                is Resource.Error -> {
                    requireActivity().hideLoader()
                    requireActivity().showErrorDialog(resource.message.toString())
    ...
    private fun stopObservers() {
        ...
        viewModel.deleteContactGroupAction.removeObservers(this)
    }
}
