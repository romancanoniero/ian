...
class LoginFragment : Fragment(), LoginActivityCallback {
    ...
    */
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding =DataBindingUtil.setContentView(requireActivity(), R.layout.activity_login)
        //binding = ActivityLoginBinding.inflate(inflater, container, false)

        setupUI()
        viewModel = LoginActivityViewModel(requireContext())
...
/*
            if (phoneNumberExists as Boolean) {
                ...
                val options = PhoneAuthOptions.newBuilder(FirebaseAuth.getInstance())
                    ...
                    .setActivity(requireContext()) // Activity (for callback binding)
  ...
  //                  googleSignInLauncher.launch(signInIntent)
    ...
    */
    ...
    private fun handleIntentData() {
        val emailLink = requireActivity().intent.data.toString()
...
*/
        ...
        binding.loginButton.setOnClickListener(View.OnClickListener {
            ...
            when (viewModel.loginMethod.value) {
                ...
                LoginMethodsEnum.PHONENUMBER -> {
                    ...
                    viewModel.onLoginWithPhoneNumberClicked(requireActivity(), phoneNumber)
                }
    ...
    private fun switchToEmailLoginMethod() {
        ...
        Glide.with(requireContext()).asBitmap().load(R.drawable.by_email_image)
    ...
    private fun switchToPhoneNumberLoginMethod() {
        ...
        Glide.with(requireContext()).asBitmap().load(R.drawable.by_phone_email)
            .into(binding.loginTypeImage)
    ...
    override fun onLogedIn(user: FirebaseUser) {
        ...
        requireActivity().broadcastMessage(
            requireActivity().intent.extras, AppConstants.ServiceCode.BROADCAST_ACTION_GO_TO_MAIN_ACTIVITY
        )
