...
public class LocationUpdatesComponent {
     ...
     */
    private static final long UPDATE_INTERVAL_IN_MILLISECONDS = 3 * 1000L;
    ...
    public void requestLocationUpdates() {
        ...
        try {
            Log.i(TAG, "Requesting location updates - 1");
            removeLocationUpdates();
            ...
            Log.i(TAG, "Requesting location updates - 3");
...
//        Toast.makeText(getApplicationContext(), "onNewLocation " + location, Toast.LENGTH_LONG).show();
    ...
    private void createLocationRequest() {
        Log.d(TAG, "Creo el location request");
        mLocationRequest = new LocationRequest();
        mLocationRequest.setInterval(UPDATE_INTERVAL_IN_MILLISECONDS);
        mLocationRequest.setFastestInterval(FASTEST_UPDATE_INTERVAL_IN_MILLISECONDS);
        mLocationRequest.setInterval(10 * 1000L);
        mLocationRequest.setFastestInterval(15 * 1000L);
